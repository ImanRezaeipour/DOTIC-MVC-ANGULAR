...
using PTC.DOTIC.Web.Controllers.Results;
using PTC.DOTIC.Web.Models.Account;
using PTC.DOTIC.Web.MultiTenancy;
using Recaptcha.Web;
using Recaptcha.Web.Mvc;
using Newtonsoft.Json;
using PTC.DOTIC.Security;
using PTC.DOTIC.Web.Auth;
using PTC.DOTIC.Web.Models.Layout;

namespace PTC.DOTIC.Web.Controllers
{
    public class AccountController : DOTICControllerBase
    {
