...
using PTC.DOTIC.Web.App.Startup;//SPA!
using PTC.DOTIC.Web.Bundling;
using PTC.DOTIC.Web.Navigation;
using PTC.DOTIC.Web.Routing;
using PTC.DOTIC.WebApi;
...
namespace PTC.DOTIC.Web
{
    ...
    [DependsOn(
        ...
        typeof(DOTICDataModule),
        typeof(DOTICApplicationModule),
        typeof(DOTICWebApiModule),
    ...
    public class DOTICWebModule : AbpModule
    {
